...
# Add user local bin directory to PATH if it exists
if [ -d "$HOME/.local/bin" ] ; then
    PATH="$HOME/.local/bin:$PATH"
fi

export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/root/Projects/AI_Infra/Tensorrt/TensorRT/TensorRT-10.0.1.6/targets/x86_64-linux-gnu/lib

export PATH=$PATH:/root/Projects/AI_Infra/Tensorrt/TensorRT/TensorRT-10.0.1.6/bin
